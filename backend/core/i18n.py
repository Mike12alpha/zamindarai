...
2. وجہ
3. فوری علاج (درست زہر + فی ایکڑ مقدار)
4. نامیاتی متبادل
...
- SoilAdvisor: کھاد، مٹی کی قسم، پانی، سینچائی
- DealGuardian: معاہدہ، بیچنامہ، سودے کی حفاظت، دستخط

صرف درست JSON واپس کریں۔ JSON کے اندر سارے الفاظ اردو میں ہوں:
{{
  "agents_needed": ["PriceOracle", "DealGuardian"],
  ...
  "entities": {{
    ...
    "offered_price": 25,
    "quantity": "1000 کلو",
    "buyer_name": "مقامی آڑتی",
    "district": "گوجرانوالہ",
    "question": "اگلے سیزن کے لیے کون سی کھاد استعمال کرنی چاہیے؟"
  }},
  "urgency": "high"
}}"""
    },
